...
## フェーズ1: プロジェクト雛形 ✅
- [x] `app-by-claude/` ディレクトリでVite + React + TSを初期化
- [x] ESLint / Prettier / Vitest / Testing Library / Playwright をセットアップ
- [x] `npm run lint && npm run test:run && npm run build` が成功することを確認
